...
<div class="row">
	<div id="breadcrumb" class="col-xs-12">
		<ol class="breadcrumb">
			...
			<li><a href="#">รายงาน JOB สรุปผล</a></li>
		</ol>
	</div>
</div>
<div class="row">
		...
		<div class="box">
			...
			<div class="box-content">
				<div class="row">
					...
					<div class="col-xs-12">
						<form method="POST" action="{{URL::to('report/repair/technician-export')}}">
							<div class="row">
								<div class="col-xs-12">
...
<script type="text/javascript">
	...
	function TableStatus(){
		var table = $('#tbl').dataTable( {
	        ...
	        "serverSide": true,
	        "iDisplayLength": 20,
	        "ajax": "{{URL::to('report/repair/technician-data')}}",
	        "columnDefs": [
			{
	...
	$(document).ready(function() {
	    ...
	    function reloadtable(tech)
	    {
	    	...
	    	if(date1!="Invalid Date" && date2 != "Invalid Date")
	    	{
		    	...
		    	$('#tbl').dataTable().api().ajax.url("{{URL::to('report/repair/technician-data/')}}/"+tech+"/"+ds1+"/"+ds2).load();
	    	}
	    }
